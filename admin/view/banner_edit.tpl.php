...
<div style="min-width:780px">
 ...
 <table width="98%" border="0" cellpadding="0" cellspacing="0" style="margin-top:10px" bgcolor="#D6D6D6" align="center">
  <tr>
   ...
   <form action="/admin/advert/banner_update/" method="POST"  enctype="multipart/form-data">
<div id="_mainsearch">
      ...
      <tr align="center" height="25" bgcolor="#F9FCEF">
       <td width="300">广告封面: </td>
        ...
        <img src="/<?php echo $data[0]['images']; ?>"  width="170px" height="70px" />
            <input type="file" value="" name="uploadinput[]" class="upload-file"/>
        </td>
      </tr>
      </tr><tr align="center" height="25" bgcolor="#F9FCEF">
       <td width="300">轮播图分类: </td>
       <td align="left" style="padding:3px;resize:none"><input type="text" name="cat" value="<?php echo $data[0]['cat']; ?>"></td>
      </tr>
      </tr><tr align="center" height="25" bgcolor="#F9FCEF">
       <td width="300">排序: </td>
       <td align="left" style="padding:3px;resize:none"><input type="text" name="sorts" value="<?php echo $data[0]['sorts']; ?>"></td>
      </tr>
      <tr align="center" height="25" bgcolor="#F9FCEF">
