...
<div style="min-width:780px">
 <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6D6D6" align="center">
      <tr>
           <td height="28" background="/admin/resources/images/tbg.gif" style="padding-left:10px;"><b>文章修改：</b></td>
      </tr>
 </table>
 <table width="98%" border="0" cellpadding="0" cellspacing="0" style="margin-top:10px" bgcolor="#D6D6D6" align="center">
  <tr>
   <td bgcolor="#FFFFFF" width="100%">
   <form action="/index.php?app=admin&act=article-update" method="POST"  enctype="multipart/form-data">
<div id="_mainsearch">
       ...
       <td align="left" style="padding:3px;"><input type="text" value="<?php echo $data[0]['cntitle']; ?>" name="cntitle" style="width:400px"/></td>
      </tr>
      <tr align="center" height="25" bgcolor="#ffffff">
       <td width="300">英文标题: </td>
       <td align="left" style="padding:3px;resize:none"><textarea name='entitle' row='4' id='edit___cfg_powerby' class='textarea_info' style='width:98%;height:50px'><?php echo $data[0]['entitle']; ?></textarea></td>
      </tr>
      </tr><tr align="center" height="25" bgcolor="#F9FCEF">
       <td width="300">单词内容: </td>
       <td align="left" style="padding:3px;resize:none">
        <script id="editor" type="text/plain" style="width:100%;height:300px;" name="content" ><?php echo  htmlspecialchars_decode($data[0]['content']); ?></script></td>
      </tr>
      
      
      <input type="hidden" name="id" value="<?php echo $data[0]['wid']; ?>">
       <tr align="center" height="25" bgcolor="#F9FCEF">
       <td width="300"></td>
