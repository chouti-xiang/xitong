...
function g_alert(type,cont,url){
	//html	
	var html = '<div id="g_all"></div><div id="g_box" style="z-index:1; position:fixed"><div id="g_title">提示</div><div id="g_cont"><img width="196px" height="74px"><span id="g_msg">'+cont+'</span></div><div id="g_buttom"><div id="g_button"><a class="butt" id="ok">确定</a> <a class="butt" id="false">取消</a></div></div></div>';
	$('body').append(html);
	...
	css += "#g_msg{position:relative; top:-25px; font-size:25px;margin-left:40px;}";
	...
	//类型为confirm
	if(type == 'confirm'){
		$('#g_cont img').attr('src','/project/resources/img/head_logo.png');
	}
